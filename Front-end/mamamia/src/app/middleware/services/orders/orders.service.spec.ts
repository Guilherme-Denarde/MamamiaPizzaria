    ...
    const mockProducts: Product[] = [
        {
            ...
            price: 19.99,
            flavor: { id: 1, flavorName: 'Flavor 1', flavorPrice: 5.99, flavorIngredients: 'Ingredient 1, Ingredient 2' },
            quantity: 10,
            imageUrl: 'image1.jpg',
            stars: 4.5,
        },
        {
            ...
            price: 24.99,
            flavor: { id: 2, flavorName: 'Flavor 2', flavorPrice: 6.99, flavorIngredients: 'Ingredient 3, Ingredient 4' },
            quantity: 8,
            imageUrl: 'image2.jpg',
            stars: 4.0,
        },
